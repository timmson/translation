...
Как написать хороший модульный тест -- не секрет. Для того чтобы это сделать, вы должны создавать "легко тестируемый" дизайн ваших систем.

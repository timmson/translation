...
Кросс-функциональность означает, что команда обладает всеми ключевыми функциями, необходимыми в проекте, обычно как минимум Инженерию, Маркетинг, производство [[Smith07]](http://www.amazon.com/Flexible-Product-Development-Building-Changing/dp/0787995843).
